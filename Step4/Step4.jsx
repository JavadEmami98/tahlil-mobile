  ...
  return (
    <div>
        ...
        <div className="flex relative justify-center items-center">
          <div className=" z-0 flex flex-col justify-center lg:mt-[200px] md:mt-[100px] mt-[100px] lg:mx-0 mx-2 lg:pr-[30px] pr-[20px] text-[#0A0A0A] w-full bg-[#F89833] lg:rounded-[18px] rounded-[12px] lg:h-[193px] h-[83px] lg:ml-[100px] ml-[100px]">
        ...
        <div className="lg:pr-[30px] lg:mx-0 lg:px-0 mx-3 px-[15px] lg:text-[25px] md:text-[15px] text-[13px] my-[15px] text-[#0A0A0A] leading-[1.85] mt-[75px]">
          <span>
            - بررسی مدارک مورد نیاز و تکمیل فرم ها.
            <br />
            - بررسی مدارک ضامن (در صورت نیاز به ضامن).
            <br />- ارائه چک ضمانت به کارشاناسان بانک.
          </span>
        </div>
      </div>
      </div>
